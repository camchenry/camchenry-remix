      ...
      <footer className="container mx-auto p-3 text-center">
        ...
        <div className="flex my-4 align-center justify-center">
          <a
            ...
            className="pr-5"
            href="mailto:cameronamchenry@gmail.com"
          >
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fas"
              data-icon="envelope"
              className="w-12 bg-gray-200 text-gray-700 dark:bg-gray-700 dark:text-gray-200 hover:bg-blue-200 dark:hover:bg-blue-900 dark:hover:text-gray-100 hover:text-gray-900 transition p-3 rounded-lg"
              role="img"
